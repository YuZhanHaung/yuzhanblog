...
def category(request, category_id):
    ...
    c = get_object_or_404(models.Entry, id=category_id)
...
def permission_denied(request, template_name='blog/403.html'):

    return render(request, template_name, locals())

def page_not_found(request, template_name='blog/403.html'):

    return render(request, template_name, locals())

def page_error(request, template_name='blog/500.html'):
